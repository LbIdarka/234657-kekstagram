...
(function () {
  ...
  var urlFoto = randomFotos.sort(window.random.mixArr);
  var randomComments = COMMENTS.sort(window.random.mixArr);
  ...
  var getFotos = function () {
    ...
    for (var i = 0; i < FOTOS_NUMBERS; i++) {
      var foto = {
        ...
        description: window.random.getRandomElement(DESCRIPTION)
      };
      fotos.push(foto);
    }
    return fotos;
